		...
		<div class="flex flex-col gap-6 py-0 sm:flex-row sm:items-start">
			...
			<div class="grid flex-1 gap-4">
				<div class="grid grid-cols-4 items-center gap-4">
					<Label for="name" class="text-right font-sm">Name</Label>
					<Input
						id="name"
						value="Diogo Marques"
						class="col-span-3"
				...
				<div class="grid grid-cols-4 items-center gap-4">
					<Label for="password" class="text-right font-sm">Password</Label>
					<Input
						id="password"
						type="password"
						value="password"
				...
				<div class="grid grid-cols-4 items-center gap-4">
					<Label for="confirm-password" class="text-right font-sm">Confirm</Label>
					<Input
						id="confirm-password"
						type="password"
						value="password"
